...
START
    BSF TRISB, SWT1    ; Torna o swt1 como entrada -> TRISB
    BSF TRISB, SWT2    ; Torna o swt2 como entrada -> TRISB
    ClRF TRISD        ; torna a porta D como saída
    
    LOOP
	BTFSC PORTB, SWT1 ; Verficar se o portb na posição stw1 é 0 ou 1
	CALL INCREMENT
	BTFSC PORTB, SWT2 ; Verificar se o portb na posição stw2 é 0 ou 1
	CALL DECREMENT
    ...
    INCREMENT
      ...
      CALL	    DELAY200MS
      CALL	    DELAY200MS	;}
      BTFSS	    PORTB,SWT1	; pula caso o botão ainda esteja pressionado depois de 1 segundo
      RETURN
    ...
    DECREMENT
      ...
      CALL	    DELAY200MS
      CALL	    DELAY200MS	;}
      BTFSS	    PORTB,SWT2	; Caso o botão ainda esteja pressionado depois de 1 sec
      RETURN
    ...
    BTFSC PORTB,SWT1		;Caso o pino stw1 fique em zero em algum momento ele retorna
    RETURN			;Retorna para a ultima posição antes da função
    BTFSC PORTB,SWT2		;Caso o pino stw2 um fique em zero em algum momento ele não pula 
    RETURN			;Retorna para a ultima posição antes da função
