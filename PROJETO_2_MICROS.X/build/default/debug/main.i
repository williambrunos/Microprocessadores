...
void main(void) {
    ...
    while (1) {
        ...
        switch(PORTD) {
            case (0b00000001):
                _delay((unsigned long)((1.911)*(4e6/4000.0)));
                break;
            case (0b00000010):
                _delay((unsigned long)((1.7025)*(4e6/4000.0)));
                break;
            case (0b00000100):
                _delay((unsigned long)((1.517)*(4e6/4000.0)));
                break;
            case (0b00001000):
                _delay((unsigned long)((1.4315)*(4e6/4000.0)));
                break;
            case (0b00010000):
                _delay((unsigned long)((1.2755)*(4e6/4000.0)));
                break;
            case (0b00100000):
                _delay((unsigned long)((1.1365)*(4e6/4000.0)));
                break;
            case (0b01000000):
                _delay((unsigned long)((1.0125)*(4e6/4000.0)));
                break;
            case (0b10000000):
                _delay((unsigned long)((0.9555)*(4e6/4000.0)));
                break;
            default:
                continue;
        }
